  ...
  return (
    <section>
      <div className="bg-gray-900 rounded-lg p-4">
        <h2 className="text-2xl font-bold text-white mb-6">Most Read</h2>
        <div className="space-y-4 px-2">
          {items.map((article, index) => (
            ...
            >
              <span className="text-lg font-bold text-red-400 w-6 text-center flex-shrink-0 leading-none pt-1">
                {index + 1}
              </span>
